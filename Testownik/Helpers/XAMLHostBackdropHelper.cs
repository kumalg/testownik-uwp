...
{
    public class XAMLHostBackdropHelper
    {
        ...
        public static readonly DependencyProperty BackgroundProperty =
            DependencyProperty.Register("Background", typeof(Color), typeof(XAMLHostBackdropHelper), new PropertyMetadata(Colors.Yellow, OnBackgroundChanged));
