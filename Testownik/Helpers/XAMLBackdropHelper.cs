...
{
    public class XAMLBackdropHelper
    {
        ...
        public static readonly DependencyProperty BackgroundProperty =
            DependencyProperty.Register("Background", typeof(Color), typeof(XAMLBackdropHelper), new PropertyMetadata(Colors.Yellow, OnBackgroundChanged));
